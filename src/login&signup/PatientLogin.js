...
const Login=()=>{
    ...
    //     // Handle successful login response (e.g., store token or session information)
    ...
    return(
        <Grid>
            ...
            <Paper elevation={10} style={paperStyle}>
                ...
                <TextField id="outlined-basic" style={textfieldStyle} label="Email" type="email" placeholder='Email' /*value={email} onChange={handleEmailChange}*/ fullWidth Required/>
                <TextField id="outlined-basic" style={textfieldStyle} label="Password" type="password" placeholder='Password' 
                /*value={password} onChange={handlePasswordChange}*/ fullWidth Required/>
